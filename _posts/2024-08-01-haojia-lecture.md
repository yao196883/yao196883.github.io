...
$AM\cap BC=:D\ ,CN\cap AB=:F\ ,DF\cap \Omega =:P$
...
![Image View](https://yao196883.github.io/img/math/Pick.png){: width="375" height="526" .w-50 .left}
...
而 $Vol(\Omega)=\sum_{a_1,a_2,\dots,a_n\in\mathbb{Z}}Vol(\Omega_{a_1,a_2,\dots,a_n})>2^n$ . 矛盾!<br>
...
$X:=\{(x,y,z,w):p|x-(sz+tw),p|y-(sw-tz)\}$ (Form a lattice)(亦满足群的性质)
